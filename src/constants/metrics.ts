...
export const METRICS: {
  ...
  initial_load: {
    total_load_time: {
      ...
      description:
        'The time from the user clicks the checkout button till the last long task completes and the main thread is idle for 500ms (Checkout is loaded and interactive)',
    },
    tti_internal: {
      name: 'Internal TTI',
      description:
